...
function render() {
    ...
    let renderTodo = listTodo.map(function (value, index) {
        ...
        return `
            ...
            <div class="function">
                    <button onclick="edit(${index}, 'todo')" class="edit"><img src="./img/Edit.png" alt=""></button>
                    <button onclick="deletee(${index}, 'todo')" class="delete"><img src="./img/Delete.png" alt=""></button>
    ...
    let renderDoing = listDoing.map(function (value, index) {
        ...
        return `
            ...
            <div class="function">
                    <button onclick="edit(${index}, 'doing')" class="edit"><img src="./img/Edit.png" alt=""></button>
                    <button onclick="deletee(${index}, 'doing')" class="delete"><img src="./img/Delete.png" alt=""></button>
                    <input type="text" class="indexBox" name="" id="">
